...
-- Tiempo de generación: 05-05-2024 a las 22:06:16
...
INSERT INTO `cliente` (`id`, `nombre`, `correo`, `contraseña`) VALUES
(5, 'Steve', 'steve.gonzalez2005@gmail.com', '$2y$12$xQxETdarKUSm.bxY57GThuZq7fWGRqRpzaADGiaU6yP..aGFBoTd.');
...
CREATE TABLE IF NOT EXISTS `reserva` (
  ...
  `monto` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `vehiculo` (
  ...
  `transmision` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
