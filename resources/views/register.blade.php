        ...
        <div class="row">
            ...
            <div class="col-lg-6 ">
                ...
                <form class="contact-form  d-flex flex-column justify-content-center align-items-center mt-5">
                    ...
                    <div class="form-field">
                        <input id="email" class="input-text js-input" type="password" required>
                        <label class="label" for="email">Confirmar Contraseña</label>
                    </div>
                    <div>
                        <small class="form-field"><a href="{{ url('/login') }}" class="text-decoration-none">¿Ya tiene cuenta? Inicia sesión aquí</a></small>
                    </div>
                    <div class="form-field">
